...
<head>
    ...
    <title>Consultar Consulta Médica</title>
    ...
    <div class="container-form">
        ...
        <form action="index.php" method="post">
            ...
            <div class="div-form">
                ...
                <fieldset>
                    <legend>Consulta de Consultas Médicas</legend>
                    ...
                    <input type="text" id="diagnostico_principal" name="diagnostico_principal" placeholder="Ingresar código CIE-10">
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Motivo Consutla</th>
                                <th>Largo</th>
                                <th>Ancho</th>
                                <th>Profundidad</th>
                                <th>Forma</th>
                                <th>Olor</th>
                                <th>Bordes de la herida</th>
                                <th>Infección</th>
                                <th>Tipo de Exudado</th>
                                <th>Nivel de Exudado</th>
                        ...
                        <tbody>
                            ...
                            <?php
                            if (isset($_POST['id_consulta']) || isset($_POST['id_cita']) || isset($_POST['id_enfermera']) 
                            || isset($_POST['id_paciente']) || isset($_POST['diagnostico_principal']) || isset($_POST['motivo_conuslta']) 
                            || isset($_POST['largo']) || isset($_POST['ancho']) || isset($_POST['profundidad']) || isset($_POST['forma']) 
                            || isset($_POST['olor']) || isset($_POST['bordes_herida']) || isset($_POST['infeccion'])  
                            || isset($_POST['exudado_tipo'])  || isset($_POST['exudado_nivel']) || isset($_POST['fecha_atencion']) 
